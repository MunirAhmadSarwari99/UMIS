...
include_once('../controller/teacherAttendanceController.php');
$flash->flash();
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card card-printable style-primary">
            <div class="card-head">
                <strong class="title-card-head">Teacher Attendance</strong>
                <div class="tools">
                    <div class="btn-group">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr id="<?php echo $row["id"];?>">
                                ...
                                <td class="setting text-right">
                                    <a href="#" data-role='edit-teacher-attr' data-id="<?php echo $row["id"];?>" data-target='edit-attr' class="btn btn-success"><i class="md md-edit"></i></a>
                                    <form class="delete_form" method="POST" action="../controller/deleteTeacherAttendanceController.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="textModalLabel">New Teacher Attendance</h4>
            </div>
            <div class="modal-body">
                <form class="form" method="POST" action="../controller/createTeacherAttendanceController.php" enctype="multipart/form-data">
                    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="checkbox-inline checkbox-styled checkbox-success">
                                                <input type="radio" class="TeacherAttendance" name="<?php echo $row['id']; ?>" value="1"><span>Present</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label class="checkbox-inline checkbox-styled checkbox-success">
                                                <input type="radio" class="TeacherAttendance" name="<?php echo $row['id']; ?>" value="0"><span>Absences</span>
                                            </label>
                                        </td>
                                        <td><?php echo $row['id']; ?></td>
                                        <td><?php echo $allTeacher['AllTeacher']; ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
...
<div class="modal TATTR fade" id="edit-attr" tabindex="-1" role="dialog" aria-labelledby="edit-attr" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="textModalLabel">Edit Teacher Attendance</h4>
                <h5 id="stName" class="text-center text-primary"></h5>
            </div>
            <div class="modal-body">
                <form class="form" method="POST" action="../controller/EditTeacherAttendanceController.php" enctype="multipart/form-data">
                    <br>
                    <div class="row">
                        <div class="col-sm-6">
