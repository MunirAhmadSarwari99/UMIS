...
include_once('../controller/teacherDetailsController.php');
$flash->flash();
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card card-printable style-primary">
            <div class="card-head">
                <strong class="title-card-head">Teacher Details</strong>
                <div class="tools">
                    <div class="btn-group">
                        ...
                        <a href="teachers.php" class="btn btn-floating-action btn-primary" ><i
                                            ...
                                            <div class="col-xs-8">
                                                <img class="img-thumbnail"
                                                     src="<?php if ($result['image'] == 'default.png') {
                                                         ...
                                                         echo "../public/Storage/Teacher/" . $result['image'];
                                                     } ?>"><br>
                                            </div>
                                        </div><!--end .row -->
                                        <!-- END INVOICE HEADER -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form floating-label" method="POST" action="../controller/editTeacherController.php" enctype="multipart/form-data">
                    <div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <select name="faculty" class="form-control" id="facultyT">
                                        <option></option>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department" class="form-control" id="departmentT" disabled>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="teacherId" value="<?php echo $result['id'] ?>" required>
