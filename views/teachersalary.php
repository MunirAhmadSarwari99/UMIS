...
include_once('../controller/teacherSalaryController.php');
$flash->flash();
?>
<div class="row">
    <div class="col-lg-12">
        <div class="card card-printable style-primary">
            <div class="card-head">
                <strong class="title-card-head">Teacher Salary</strong>
                <div class="tools">
                    <div class="btn-group">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr id="<?php echo $row["id"];?>">
                                ...
                                <td class="setting text-right">
                                    <a href="#" data-role='edit-teacher-salary' data-id="<?php echo $row["id"];?>" data-target='edit-teacher-salary' class="btn btn-success"><i class="md md-edit"></i></a>
                                    <form class="delete_form" method="POST" action="../controller/deleteTeacherSalaryController.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="textModalLabel">New Teacher Salary</h4>
            </div>
            <div class="modal-body">
                <form class="form" method="POST" action="../controller/createTeacherSalaryController.php" enctype="multipart/form-data">
                    <br>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <label for="staffName">Teacher Name</label>
                            </div>
                        </div>
...
<!-- BEGIN EDIT PROFILE MODAL MARKUP -->
    <div class="modal tSalary fade" id="edit-teacher-salary" tabindex="-1" role="dialog" aria-labelledby="edit-teacher-salary" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="textModalLabel">Edit Teacher Salary</h4>
                <h5 id="tName" class="text-center text-primary"></h5>
            </div>
            <div class="modal-body">
                <form class="form" method="POST" action="../controller/EditTeacherSalaryController.php">
                    <br>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <select name="teacherNames" class="form-control" id="teacherNames">
                                    <option value=""></option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" name="amount" class="form-control" id="amounts" required>
                                <label for="amount">Amount</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="date" name="salaryDate" class="form-control" id="salaryDates" required>
                                <label for="salaryDate">salary Date</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="number" name="bonus" class="form-control" min="100" max="500" id="bonuses" required>
                                <label for="bonus">Bonus</label>
                            </div>
                        </div>
                        <div class="col-md-6">
